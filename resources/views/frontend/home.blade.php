<x-layout-site>
    ...
    {{-- <section class="py-10" id="services">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap items-center justify-center p-4">
                <a href="#"
                    class="bg-green-400 hover:shadow hover:bg-red-500 transition duration-150 px-2 py-1 rounded text-sm text-white mx-1 my-2">
                    Laravel
                </a>
                <a href="#"
                    class="bg-green-400 hover:shadow hover:bg-red-500 transition duration-150 px-2 py-1 rounded text-sm text-white mx-1 my-2">
    ...
    <section class="py-10" id="services">
        <div class="bg-white py-16">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold text-black mb-8">Product Sale</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        <div class="relative overflow-hidden">
                            <img class="object-cover w-full h-full"
    ...
    {{-- <div class="container mx-auto my-8 px-2">
        <ul class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5">
            <li
                ...
                <a class="relative" href="{{url('/bai-viet/slug')}}">
                ...
                <a class="relative" href="/tool/writemeai">
                    <div class="relative w-full aspect-video">
                        <img class="rounded w-full h-full object-cover"
                            ...
                            alt="WriteMe.ai" loading="lazy" />
                        <div
                            class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
                            <h2 class="text-xl font-semibold">WriteMe.ai</h2>
            ...
            <li
                ...
                <a class="relative" href="/tool/publer">
                    <div class="relative w-full aspect-video">
                        <img class="rounded w-full h-full object-cover"
                            ...
                            alt="Publer" loading="lazy" />
                        <div
                            class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
                            <h2 class="text-xl font-semibold">Publer</h2>
                            <p class="font-medium text-sm">Your Social Media Superhero</p>
                        </div>
                    </div>
                </a>
                ...
                <div class="flex flex-col justify-beetween gap-3 px-4 py-2">
                    <p class="text-gray-600 two-lines">
                        ...
                        range of features including post scheduling, collaboration tools,
